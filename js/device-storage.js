...
class DeviceStorageManager {
  ...
  // =========================================================================
  //  RECONNECT — called from Settings "Change Folder" button
  // =========================================================================
  ...
  async getDateDetails(dateStr) {
    ...
    const totalRevenue = dateSales.reduce((s, x) => s + parseFloat(x.total  || 0), 0);
    const totalProfit  = dateSales.reduce((s, x) => s + parseFloat(x.profit || 0), 0);
